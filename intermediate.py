from series import *
from semantic import Entorno, Simbolo
...
class GeneradorIntermedio:
    ...
    def generar_ExpresionLlamadaFuncion(self, nodo):
        ...
        if nodo.recibe and nodo.recibe is not None:
            ...
            self.emitir(f"POP_RETVAL {temp_retorno} ") #Esto se tiene que corregir para ajustarse al optimizador y generador, lo cmabie de asignar a el opcode pop
            return temp_retorno
        else:
            return None
